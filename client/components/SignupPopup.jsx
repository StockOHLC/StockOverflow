...
const SignupPopup = props => {
    ...
    return (
        ...
        <span className= "closeButton" onClick={handleSave}>X</span>
            ...
            <button>
                <a href={`https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=${CLIENT_ID}&scope=r_basicprofile&state=${state}&redirect_uri=http://localhost:8080/oauth/linkedin/callback`}>
